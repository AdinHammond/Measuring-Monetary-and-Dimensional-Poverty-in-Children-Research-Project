...
gen extreme_pov_w4 = 0 if round == 4
	replace extreme_pov_w4 = 1 if totalexp_pc_w4 < (17.34*2.15*30)
...
*The 17.34 accounts for the ethiopian currency difference. The 30 accounts for the data being measured in monthly expenditures

gen moderate_pov_w4 = 0 if round == 4
	replace moderate_pov_w4 = 1 if totalexp_pc_w4 < (17.34*3.65*30)
...
gen extreme_pov_w5 = 0 if round == 5
	replace extreme_pov_w5 = 1 if totalexp_pc_w5 < (20.65*2.15*30)
gen moderate_pov_w5 = 0 if round == 5
	replace moderate_pov_w5 = 1 if totalexp_pc_w5 < (20.65*3.65*30)
