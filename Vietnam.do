...
gen extreme_pov_w4 = 0 if round == 4
	replace extreme_pov_w4 = 1 if totalexp_pc_w4 < (7369.89*2.15*30/1000)
gen moderate_pov_w4 = 0 if round == 4
	replace moderate_pov_w4 = 1 if totalexp_pc_w4 < (7369.89*3.65*30/1000)

* Round 5
gen totalexp_pc_w5 = totalexp_new if round == 5
gen extreme_pov_w5 = 0 if round == 5
	replace extreme_pov_w5 = 1 if totalexp_pc_w5 < (7395.34*2.15*30/1000)
gen moderate_pov_w5 = 0 if round == 5
	replace moderate_pov_w5 = 1 if totalexp_pc_w5 < (7395.34*3.65*30/1000)
